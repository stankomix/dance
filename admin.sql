...
--
-- Host: 127.0.0.1:3306
-- Erstellungszeit: 27. Feb 2018 um 10:05
...
--
-- Tabellenstruktur für Tabelle `abotype`
--

DROP TABLE IF EXISTS `abotype`;
CREATE TABLE IF NOT EXISTS `abotype` (
...
--
-- Tabellenstruktur für Tabelle `abotypecoursetype`
--

DROP TABLE IF EXISTS `abotypecoursetype`;
CREATE TABLE IF NOT EXISTS `abotypecoursetype` (
...
--
-- Daten für Tabelle `abotypecoursetype`
--
...
CREATE TABLE IF NOT EXISTS `anfragen` (
  `anfrageid` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`anfrageid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `articlesale`
--

DROP TABLE IF EXISTS `articlesale`;
CREATE TABLE IF NOT EXISTS `articlesale` (
  `articlesaleid` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`articlesaleid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `articletype`
--
...
--
-- Tabellenstruktur für Tabelle `breaks`
--

DROP TABLE IF EXISTS `breaks`;
CREATE TABLE IF NOT EXISTS `breaks` (
  `breakid` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Tabellenstruktur für Tabelle `contentperson`
--

DROP TABLE IF EXISTS `contentperson`;
CREATE TABLE IF NOT EXISTS `contentperson` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Daten für Tabelle `contentperson`
--
...
--
-- Tabellenstruktur für Tabelle `coursecategories`
--
...
--
-- Daten für Tabelle `coursecategories`
--
...
--
-- Tabellenstruktur für Tabelle `courseday`
--

DROP TABLE IF EXISTS `courseday`;
...
--
-- Tabellenstruktur für Tabelle `courseperson`
--

DROP TABLE IF EXISTS `courseperson`;
CREATE TABLE IF NOT EXISTS `courseperson` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Daten für Tabelle `courseperson`
--
...
(53, 1, 3545, '2018-01-24 20:56:56', 0, '0000-00-00 00:00:00'),
(56, 5, 3545, '2018-01-24 21:01:03', 0, '2018-01-24 21:01:03'),
(57, 3, 3545, '2018-01-26 00:18:03', 0, '0000-00-00 00:00:00'),
...
--
-- Stellvertreter-Struktur des Views `echeckin_user`
-- (Siehe unten für die tatsächliche Ansicht)
--
DROP VIEW IF EXISTS `echeckin_user`;
CREATE TABLE IF NOT EXISTS `echeckin_user` (
`teilnehmerid` int(11)
,`vorname` varchar(50)
,`nachname` varchar(50)
,`email` varchar(50)
...
--
-- Tabellenstruktur für Tabelle `invoicestate`
--

DROP TABLE IF EXISTS `invoicestate`;
CREATE TABLE IF NOT EXISTS `invoicestate` (
  `invoicestate` int(11) NOT NULL,
  `desc` varchar(255) NOT NULL,
  PRIMARY KEY (`invoicestate`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `invoicestate`
--
...
--
-- Tabellenstruktur für Tabelle `invoicetype`
--
...
--
-- Stellvertreter-Struktur des Views `invoicev`
-- (Siehe unten für die tatsächliche Ansicht)
--
DROP VIEW IF EXISTS `invoicev`;
CREATE TABLE IF NOT EXISTS `invoicev` (
`invoiceid` int(11)
,`invoicetype` int(11)
...
--
-- Tabellenstruktur für Tabelle `janein`
--

DROP TABLE IF EXISTS `janein`;
CREATE TABLE IF NOT EXISTS `janein` (
  `janeinid` int(11) NOT NULL,
  `text` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`janeinid`),
  KEY `janeinid` (`janeinid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Daten für Tabelle `janein`
--
...
--
-- Tabellenstruktur für Tabelle `kassenabschluss`
--

DROP TABLE IF EXISTS `kassenabschluss`;
CREATE TABLE IF NOT EXISTS `kassenabschluss` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `kursteilnahme` (
  `Teilnahmeid` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`Teilnahmeid`),
  KEY `Kursid` (`Kursid`),
  KEY `Kursteilnehmerid` (`Kursteilnehmerid`),
  KEY `Teilnahmeid` (`Teilnahmeid`)
) ENGINE=InnoDB AUTO_INCREMENT=31604 DEFAULT CHARSET=utf8;
...
(31598, 3545, NULL, '0.00', NULL, NULL, '2018-02-23 00:00:00', '2018-03-22 00:00:00', NULL, NULL, '2018-02-08 00:08:31', NULL, NULL, NULL, NULL, NULL, 9, 2, 1, NULL, NULL, 0, 0, '', 0, 1, 0, NULL, 0, 1, 0, 0, 0, 0),
...
(31603, 3545, NULL, '0.00', NULL, NULL, '2018-02-23 00:00:00', '2018-03-25 00:00:00', NULL, NULL, '2018-02-15 22:00:30', NULL, NULL, NULL, NULL, NULL, 74, 1, 1, NULL, NULL, 0, 0, '', 0, 1, 0, NULL, 0, 1, 0, 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `kursteilnehmer` (
  `Teilnehmerid` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=12427 DEFAULT CHARSET=utf8;
...
--
-- Tabellenstruktur für Tabelle `lessongroup`
--

DROP TABLE IF EXISTS `lessongroup`;
CREATE TABLE IF NOT EXISTS `lessongroup` (
  `Kursgruppeid` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`Kursgruppeid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `lessonperson`
--

DROP TABLE IF EXISTS `lessonperson`;
CREATE TABLE IF NOT EXISTS `lessonperson` (
  ...
  PRIMARY KEY (`id`),
  KEY `kursteilnehmerid` (`kursteilnehmerid`)
) ENGINE=MyISAM AUTO_INCREMENT=143783 DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `lessonperson`
--
...
(143771, '', 3545, 0, 1, 204, 31586, 0, 0, NULL, NULL, NULL, '2018-01-26 15:21:05', NULL, 0, '2018-01-26 14:21:05', 0, 1, 0, '0000-00-00 00:00:00'),
...
(143779, '', 3545, 0, 1, 200, 31592, 0, 0, NULL, NULL, NULL, '2018-01-30 15:09:17', NULL, 0, '2018-01-30 14:09:17', 0, 1, 0, '0000-00-00 00:00:00'),
(143782, '', 3545, 0, 1, 80, 31602, 0, 0, NULL, NULL, NULL, '2018-02-15 21:59:54', NULL, 0, '2018-02-15 20:59:54', 0, 1, 0, '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `lessontype`
--
...
--
-- Tabellenstruktur für Tabelle `mailinghistory`
--

DROP TABLE IF EXISTS `mailinghistory`;
CREATE TABLE IF NOT EXISTS `mailinghistory` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Tabellenstruktur für Tabelle `mailingparam`
--

DROP TABLE IF EXISTS `mailingparam`;
CREATE TABLE IF NOT EXISTS `mailingparam` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `teilnehmerid` int(11) NOT NULL,
  `mailingid` int(11) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `manualpresence`
--

DROP TABLE IF EXISTS `manualpresence`;
CREATE TABLE IF NOT EXISTS `manualpresence` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kursteilnehmerid` int(11) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `partnerstatus`
--

DROP TABLE IF EXISTS `partnerstatus`;
...
--
-- Daten für Tabelle `partnerstatus`
--
...
--
-- Tabellenstruktur für Tabelle `persontyp`
--

DROP TABLE IF EXISTS `persontyp`;
CREATE TABLE IF NOT EXISTS `persontyp` (
  `Persontypid` int(11) NOT NULL,
  `Persontyp` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`Persontypid`),
  KEY `Persontypid` (`Persontypid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Daten für Tabelle `persontyp`
--
...
--
-- Tabellenstruktur für Tabelle `undeliveredmails`
--

DROP TABLE IF EXISTS `undeliveredmails`;
CREATE TABLE IF NOT EXISTS `undeliveredmails` (
...
--
-- Tabellenstruktur für Tabelle `usermessages`
--
...
--
-- Daten für Tabelle `usermessages`
--
...
--
-- Tabellenstruktur für Tabelle `vermittlung`
--

DROP TABLE IF EXISTS `vermittlung`;
CREATE TABLE IF NOT EXISTS `vermittlung` (
  `Vermittlung` int(11) NOT NULL,
  `Art` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`Vermittlung`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Daten für Tabelle `vermittlung`
--
...
CREATE TABLE IF NOT EXISTS `zahlungsart` (
  ...
  KEY `zahlungsartid` (`zahlungsartid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Struktur des Views `echeckin_user`
--
